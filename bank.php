...
<div id="mainContainer" class="row large-centered">
  ...
  <div class="text-center"><h2>ONLINE PAYMENT</h2></div>
  
  <hr class="divider">
  <dl class="mercDetails">
  	<dt>Merchant</dt> 				<dd>Ticket Fetch</dd>
...
<p class="form-subheading">OTP sent to your mobile number ending with <strong>4036</strong></p>
